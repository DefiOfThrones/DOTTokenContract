...
// File: chainlink\vendor\BufferChainlink.sol
...
// File: chainlink\vendor\CBORChainlink.sol
...
// File: chainlink\interfaces\ENSInterface.sol
...
// File: chainlink\interfaces\LinkTokenInterface.sol
...
// File: chainlink\interfaces\ChainlinkRequestInterface.sol
...
// File: chainlink\interfaces\PointerInterface.sol

interface PointerInterface {
  function getAddress() external view returns (address);
}

// File: chainlink\vendor\ENSResolver.sol

abstract contract ENSResolver_Chainlink  {
  function addr(bytes32 node) public view virtual returns (address);
}

// File: chainlink\ChainlinkClient.sol
